...
export default function WhatsAppFab() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-0 rounded-full bg-[#25D366] p-4 text-white shadow-lg shadow-black/40 transition-all hover:gap-2 hover:pr-5"
    >
